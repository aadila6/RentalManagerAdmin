define(['dart_sdk', 'packages/quiver/core', 'packages/plugin_platform_interface/plugin_platform_interface', 'packages/flutter/src/gestures/arena'], function(dart_sdk, packages__quiver__core, packages__plugin_platform_interface__plugin_platform_interface, packages__flutter__src__gestures__arena) {
  'use strict';
  ...
  firebase_core_platform_interface.FirebaseCorePlatform = class FirebaseCorePlatform extends plugin_platform_interface.PlatformInterface {
    static get instance() {
      return firebase_core_platform_interface.FirebaseCorePlatform._instance;
    }
    static set instance(instance) {
      plugin_platform_interface.PlatformInterface.verifyToken(instance, firebase_core_platform_interface.FirebaseCorePlatform._token);
  ...
  (firebase_core_platform_interface.FirebaseCorePlatform.new = function() {
    firebase_core_platform_interface.FirebaseCorePlatform.__proto__.new.call(this, {token: firebase_core_platform_interface.FirebaseCorePlatform._token});
    ;
  ...
  dart.defineLazy(firebase_core_platform_interface.FirebaseCorePlatform, {
    /*firebase_core_platform_interface.FirebaseCorePlatform._token*/get _token() {
  ...
  method_channel_firebase_core.MethodChannelFirebaseCore = class MethodChannelFirebaseCore extends firebase_core_platform_interface.FirebaseCorePlatform {
    ...
    allApps() {
      return async.async(ListOfPlatformFirebaseApp(), function* allApps() {
        ...
        t0$ = (t0 = result, t0 == null ? null : t0[$map](platform_firebase_app.PlatformFirebaseApp, dart.fn(app => new platform_firebase_app.PlatformFirebaseApp.new(core.String._check(dart.dsend(app, '_get', ["name"])), new firebase_options.FirebaseOptions.from(core.Map._check(dart.dsend(app, '_get', ["options"])))), dynamicToPlatformFirebaseApp())));
        return t0$ == null ? null : t0$[$toList]();
      });
    }
  };
  (method_channel_firebase_core.MethodChannelFirebaseCore.new = function() {
    method_channel_firebase_core.MethodChannelFirebaseCore.__proto__.new.call(this);
    ;
