define(['dart_sdk'], function(dart_sdk) {
  ...
  var L0 = "package:quiver/time.dart";
  dart.defineLazy(CT, {
    get C0() {
      return C0 = dart.fn(time$.systemTime, VoidToDateTimeL());
    },
    get C1() {
  ...
  var C0;
  var _time = dart.privateName(time$, "_time");
  var _time$ = dart.privateName(time$, "Clock._time");
  ...
  (time$.Clock.new = function(timeFunc = C0 || CT.C0) {
    this[_time$] = timeFunc;
    ;
  ...
  dart.setLibraryUri(time$.Clock, L0);
  ...
  time$.clampDayOfMonth = function clampDayOfMonth(opts) {
    ...
    return dart.asNullableInt(day[$clamp](1, time$.daysInMonth(year, month)));
  };
  ...
  }, '{"version":3,"sourceRoot":"","sources":["src/time/clock.dart","src/time/util.dart","src/time/duration_unit_constants.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA2CqB;;;;;;;AAGD,YAAA,AAAK;IAAE;UAGD;AAAa,YAAA,AAAM,qBAAS,QAAQ;IAAC;cAGjC;AAAa,YAAA,AAAM,gBAAI,QAAQ;IAAC;;UAM/C;UACD;UACA;UACA;UACA;UACA;AACR,wBAAM,6BACI,IAAI,SACH,KAAK,WACH,OAAO,WACP,OAAO,gBACF,YAAY,gBACZ,YAAY;IAAE;;UAMvB;UACD;UACA;UACA;UACA;UACA;AACR,4BAAU,6BACA,IAAI,SACH,KAAK,WACH,OAAO,WACP,OAAO,gBACF,YAAY,gBACZ,YAAY;IAAE;cAGb;AAAW,qCAAkB,MAAM;IAAC;kBAGhC;AAAW,yCAAsB,MAAM;IAAC;cAG5C;AAAW,qCAAkB,MAAM;IAAC;kBAGhC;AAAW,yCAAsB,MAAM;IAAC;eAG3C;AAAY,gCAAa,OAAO;IAAC;mBAG7B;AAAY,oCAAiB,OAAO;IAAC;eAGzC;AAAY,gCAAa,OAAO;IAAC;mBAG7B;AAAY,oCAAiB,OAAO;IAAC;aAG3C;AAAU,8BAAW,KAAK;IAAC;iBAGvB;AAAU,kCAAe,KAAK;IAAC;YAGpC;AAAS,6BAAU,IAAI;IAAC;gBAGpB;AAAS,iCAAc,IAAI;IAAC;aAG/B;AAAU,6BAAU,AAAE,iBAAE,KAAK;IAAC;iBAG1B;AAAU,iCAAc,AAAE,iBAAE,KAAK;IAAC;cAGrC;AACjB,iBAAO;AACP,cAA8B,AAAK,CAAnB,AAAS,aAApB,AAAK,IAAD,uBAAS,MAAM,IAAG,YAAK,MAAK;AACrC,cAAc,aAAV,AAAK,IAAD,SAAmC,EAAnB,AAAK,aAAZ,MAAM,IAAG,kBAAK,AAAK,IAAD,WAAW;AAC9C,cAAI,6BAAsB,CAAC,SAAS,CAAC,OAAO,AAAK,IAAD;AACpD,YAAO,uBACH,CAAC,EAAE,CAAC,EAAE,CAAC,EAAE,AAAK,IAAD,OAAO,AAAK,IAAD,SAAS,AAAK,IAAD,SAAS,AAAK,IAAD;IACxD;kBAG2B;AACrB,iBAAO;AACP,cAA8B,AAAK,CAAnB,AAAS,aAApB,AAAK,IAAD,uBAAS,MAAM,IAAG,YAAK,MAAK;AACrC,cAAc,aAAV,AAAK,IAAD,SAAkC,EAAlB,AAAa,aAApB,MAAM,iBAAG,AAAK,IAAD,UAAS,KAAM;AAC7C,cAAI,6BAAsB,CAAC,SAAS,CAAC,OAAO,AAAK,IAAD;AACpD,YAAO,uBACH,CAAC,EAAE,CAAC,EAAE,CAAC,EAAE,AAAK,IAAD,OAAO,AAAK,IAAD,SAAS,AAAK,IAAD,SAAS,AAAK,IAAD;IACxD;aAGsB;AAChB,iBAAO;AACP,cAAc,aAAV,AAAK,IAAD,sBAAQ,KAAK;AACrB,cAAI,6BAAsB,CAAC,SAAS,AAAK,IAAD,aAAa,AAAK,IAAD;AAC7D,YAAO,uBAAS,CAAC,EAAE,AAAK,IAAD,QAAQ,CAAC,EAAE,AAAK,IAAD,OAAO,AAAK,IAAD,SAAS,AAAK,IAAD,SAC1D,AAAK,IAAD;IACV;iBAG0B;AAAU,2BAAS,cAAC,KAAK;IAAC;;8BA5H1B;IAAgC,eAAE,QAAQ;;;gCAG/C;IAAc,eAAG,cAAM,IAAI;;EAAC;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AArB1B,UAAS;EAAK;2CCInB,MAAU;AAC1B,UAAC,AAAM,AAAqB,MAAtB,oBAAyB,iBAAW,IAAI,KAAK,KAAK,AAAY,0BAAC,KAAK;EAAC;yCAU3D;AAChB,UAAC,AAAK,AAAI,AAAM,KAAX,UAAG,OAAK,MAAQ,AAAK,IAAD,UAAG,SAAO,KAAO,AAAK,AAAM,IAAP,UAAG,SAAO;EAAG;;QAiB/C;QACA;QACA;AAEZ,8BAAA,AAAI,GAAD,SAAO,GAAG,kBAAY,IAAI,EAAE,KAAK;EAAE;;;;;;;;;;;MCzC3B,kBAAY;;;MACZ,kBAAY;;;MACZ,aAAO;;;MACP,aAAO;;;MACP,YAAM;;;MACN,UAAI;;;MACJ,WAAK;;;MDJd,kBAAY","file":"time.ddc.js"}');
  // Exports:
  return {
    time: time$
  };
