define(['dart_sdk', 'packages/plugin_platform_interface/plugin_platform_interface', 'packages/flutter/src/gestures/arena'], function(dart_sdk, packages__plugin_platform_interface__plugin_platform_interface, packages__flutter__src__gestures__arena) {
  ...
  firebase_auth_platform_interface._decodeAdditionalUserInfo = function _decodeAdditionalUserInfo(data) {
    ...
    return new firebase_auth_platform_interface.PlatformAdditionalUserInfo.new({isNewUser: core.bool._check(data[$_get]("isNewUser")), username: core.String._check(data[$_get]("username")), providerId: core.String._check(data[$_get]("providerId")), profile: MapOfString$dynamic()._check((t0 = data[$_get]("profile"), t0 == null ? null : dart.dgsend(t0, [core.String, dart.dynamic], 'cast', [])))});
  };
