define(['dart_sdk', 'packages/collection/collection'], function(dart_sdk, packages__collection__collection) {
  ...
  var dynamicAndStackTraceLToErrorResultL = () => (dynamicAndStackTraceLToErrorResultL = dart.constFn(dart.fnType(error$.ErrorResult, [dart.dynamic, core.StackTrace])))();
  var CaptureStreamTransformerOfObjectL = () => (CaptureStreamTransformerOfObjectL = dart.constFn(capture_transformer.CaptureStreamTransformer$(core.Object)))();
  var ReleaseStreamTransformerOfObjectL = () => (ReleaseStreamTransformerOfObjectL = dart.constFn(release_transformer.ReleaseStreamTransformer$(core.Object)))();
  var ResultOfObjectL = () => (ResultOfObjectL = dart.constFn(result.Result$(core.Object)))();
  var StreamTransformerWrapperOfObjectL$ResultLOfObjectL = () => (StreamTransformerWrapperOfObjectL$ResultLOfObjectL = dart.constFn(stream_transformer_wrapper.StreamTransformerWrapper$(core.Object, ResultOfObjectL())))();
  var StreamTransformerWrapperOfResultLOfObjectL$ObjectL = () => (StreamTransformerWrapperOfResultLOfObjectL$ObjectL = dart.constFn(stream_transformer_wrapper.StreamTransformerWrapper$(ResultOfObjectL(), core.Object)))();
  var EventSinkLTovoid = () => (EventSinkLTovoid = dart.constFn(dart.fnType(dart.void, [async.EventSink])))();
  var FutureOfNullN = () => (FutureOfNullN = dart.constFn(async.Future$(core.Null)))();
  var dynamicAnddynamicToLdynamic = () => (dynamicAnddynamicToLdynamic = dart.constFn(dart.fnType(dart.dynamic, [dart.dynamic, dart.dynamic])))();
  var EventSinkOfResultL = () => (EventSinkOfResultL = dart.constFn(async.EventSink$(result.Result)))();
  var EventSinkLToEventSinkLOfResultL = () => (EventSinkLToEventSinkLOfResultL = dart.constFn(dart.fnType(EventSinkOfResultL(), [async.EventSink])))();
  ...
  var ObjectLAndStackTraceLTovoid = () => (ObjectLAndStackTraceLTovoid = dart.constFn(dart.fnType(dart.void, [core.Object, core.StackTrace])))();
  var VoidTovoid = () => (VoidTovoid = dart.constFn(dart.fnType(dart.void, [])))();
  var ListQueueOf_EventRequestL = () => (ListQueueOf_EventRequestL = dart.constFn(collection.ListQueue$(stream_queue._EventRequest)))();
  var boolLToboolL = () => (boolLToboolL = dart.constFn(dart.fnType(core.bool, [core.bool])))();
  var LinkedHashSetOfStreamQueueL = () => (LinkedHashSetOfStreamQueueL = dart.constFn(collection.LinkedHashSet$(stream_queue.StreamQueue)))();
  var CompleterOfintL = () => (CompleterOfintL = dart.constFn(async.Completer$(core.int)))();
  var CompleterOfvoid = () => (CompleterOfvoid = dart.constFn(async.Completer$(dart.void)))();
  var CompleterOfboolL = () => (CompleterOfboolL = dart.constFn(async.Completer$(core.bool)))();
  var VoidToFutureOrL = () => (VoidToFutureOrL = dart.constFn(dart.fnType(dart.dynamic, [])))();
  var FutureLOfvoidToboolL = () => (FutureLOfvoidToboolL = dart.constFn(dart.fnType(core.bool, [FutureOfvoid()])))();
  ...
  var StreamSubscriptionOfListLOfintL = () => (StreamSubscriptionOfListLOfintL = dart.constFn(async.StreamSubscription$(ListOfintL())))();
  var StreamSubscriptionLOfListLOfintLAndFutureLOfUint8ListLToFutureLOfUint8ListL = () => (StreamSubscriptionLOfListLOfintLAndFutureLOfUint8ListLToFutureLOfUint8ListL = dart.constFn(dart.fnType(FutureOfUint8ListL(), [StreamSubscriptionOfListLOfintL(), FutureOfUint8ListL()])))();
  var CancelableOperationOfUint8ListL = () => (CancelableOperationOfUint8ListL = dart.constFn(cancelable_operation.CancelableOperation$(typed_data.Uint8List)))();
  var StreamSubscriptionLOfListLOfintLAndFutureLOfUint8ListLToCancelableOperationLOfUint8ListL = () => (StreamSubscriptionLOfListLOfintLAndFutureLOfUint8ListLToCancelableOperationLOfUint8ListL = dart.constFn(dart.fnType(CancelableOperationOfUint8ListL(), [StreamSubscriptionOfListLOfintL(), FutureOfUint8ListL()])))();
  var JSArrayOfListLOfintL = () => (JSArrayOfListLOfintL = dart.constFn(_interceptors.JSArray$(ListOfintL())))();
  var CompleterOfUint8ListL = () => (CompleterOfUint8ListL = dart.constFn(async.Completer$(typed_data.Uint8List)))();
  var ListLOfintLToNullN = () => (ListLOfintLToNullN = dart.constFn(dart.fnType(core.Null, [ListOfintL()])))();
  ...
  var L5 = "file:///private/var/folders/kv/jfkyvgcx1q3_7nwhmrnqw7z80000gn/T/scratch_spacenntfA9/packages/async/src/stream_sink_completer.dart";
  var L23 = "file:///private/var/folders/kv/jfkyvgcx1q3_7nwhmrnqw7z80000gn/T/scratch_spacenntfA9/packages/async/src/stream_completer.dart";
  ...
  var L27 = "file:///private/var/folders/kv/jfkyvgcx1q3_7nwhmrnqw7z80000gn/T/scratch_spacenntfA9/packages/async/src/stream_splitter.dart";
  var L35 = "package:async/src/restartable_timer.dart";
  var L30 = "file:///private/var/folders/kv/jfkyvgcx1q3_7nwhmrnqw7z80000gn/T/scratch_spacenntfA9/packages/async/src/stream_queue.dart";
  ...
  stream_subscription_transformer.subscriptionTransformer = function subscriptionTransformer(T, opts) {
    ...
    return new (async._StreamSubscriptionTransformer$(T, T)).new(dart.fn((stream, cancelOnError) => {
      let t0, t0$, t0$0;
      return new (stream_subscription_transformer._TransformedSubscription$(T)).new(stream.listen(null, {cancelOnError: cancelOnError}), (t0 = handleCancel, t0 == null ? dart.fn(inner => inner.cancel(), dart.fnType(FutureOfvoid(), [async.StreamSubscription$(T)])) : t0), (t0$ = handlePause, t0$ == null ? dart.fn(inner => {
        inner.pause();
  ...
  async_memoizer.AsyncMemoizer$ = dart.generic(T => {
    ...
    var FutureOrOfTL = () => (FutureOrOfTL = dart.constFn(async.FutureOr$(T)))();
    var VoidToLFutureOrLOfTL = () => (VoidToLFutureOrLOfTL = dart.constFn(dart.fnType(FutureOrOfTL(), [])))();
  ...
  stream_consumer.DelegatingStreamConsumer$ = dart.generic(T => {
    var StreamOfTL = () => (StreamOfTL = dart.constFn(async.Stream$(T)))();
  ...
  stream_sink_completer.StreamSinkCompleter$ = dart.generic(T => {
    var _CompleterSinkOfTL = () => (_CompleterSinkOfTL = dart.constFn(stream_sink_completer._CompleterSink$(T)))();
    var StreamSinkOfTL = () => (StreamSinkOfTL = dart.constFn(async.StreamSink$(T)))();
    var NullStreamSinkOfTL = () => (NullStreamSinkOfTL = dart.constFn(null_stream_sink.NullStreamSink$(T)))();
    class StreamSinkCompleter extends core.Object {
      ...
      get [_sink]() {
        return _CompleterSinkOfTL().as(this.sink);
      }
      ...
      setDestinationSink(destinationSink) {
        StreamSinkOfTL().as(destinationSink);
  ...
  future$.ResultFuture$ = dart.generic(T => {
    var ResultOfTL = () => (ResultOfTL = dart.constFn(result.Result$(T)))();
    var ResultLOfTLToNullN = () => (ResultLOfTLToNullN = dart.constFn(dart.fnType(core.Null, [ResultOfTL()])))();
  ...
  result.Result$ = dart.generic(T => {
    class Result extends core.Object {
      ...
      static capture(T, future) {
        return future.then(result.Result$(T), dart.fn(value => new (value$.ValueResult$(T)).new(value), dart.fnType(value$.ValueResult$(T), [T])), {onError: dart.fn((error, stackTrace) => new error$.ErrorResult.new(error, stackTrace), dynamicAndStackTraceLToErrorResultL())});
      }
  ...
  typed.TypeSafeStreamSinkTransformer$ = dart.generic((S, T) => {
    var StreamControllerOfSL = () => (StreamControllerOfSL = dart.constFn(async.StreamController$(S)))();
    var StreamSinkOfTL = () => (StreamSinkOfTL = dart.constFn(async.StreamSink$(T)))();
  ...
  stream_transformer_wrapper.StreamTransformerWrapper$ = dart.generic((S, T) => {
    var _StreamTransformerWrapperSinkOfSL$TL = () => (_StreamTransformerWrapperSinkOfSL$TL = dart.constFn(stream_transformer_wrapper._StreamTransformerWrapperSink$(S, T)))();
    var StreamSinkOfTL = () => (StreamSinkOfTL = dart.constFn(async.StreamSink$(T)))();
  ...
  stream_transformer_wrapper._StreamTransformerWrapperSink$ = dart.generic((S, T) => {
    var StreamControllerOfSL = () => (StreamControllerOfSL = dart.constFn(async.StreamController$(S)))();
    var StreamOfSL = () => (StreamOfSL = dart.constFn(async.Stream$(S)))();
  ...
  handler_transformer.HandlerTransformer$ = dart.generic((S, T) => {
    var _HandlerSinkOfSL$TL = () => (_HandlerSinkOfSL$TL = dart.constFn(handler_transformer._HandlerSink$(S, T)))();
    var StreamSinkOfTL = () => (StreamSinkOfTL = dart.constFn(async.StreamSink$(T)))();
  ...
  handler_transformer._HandlerSink$ = dart.generic((S, T) => {
    var SLAndEventSinkLOfTLToLvoid = () => (SLAndEventSinkLOfTLToLvoid = dart.constFn(dart.fnType(dart.void, [S, EventSinkOfTL()])))();
    var StreamOfSL = () => (StreamOfSL = dart.constFn(async.Stream$(S)))();
    var _StreamHandlerTransformerOfSL$TL = () => (_StreamHandlerTransformerOfSL$TL = dart.constFn(async._StreamHandlerTransformer$(S, T)))();
    var _SafeCloseSinkOfTL = () => (_SafeCloseSinkOfTL = dart.constFn(handler_transformer._SafeCloseSink$(T)))();
    var EventSinkOfTL = () => (EventSinkOfTL = dart.constFn(async.EventSink$(T)))();
    var ObjectLAndStackTraceLAndEventSinkLOfTLToLvoid = () => (ObjectLAndStackTraceLAndEventSinkLOfTLToLvoid = dart.constFn(dart.fnType(dart.void, [core.Object, core.StackTrace, EventSinkOfTL()])))();
    var EventSinkLOfTLToLvoid = () => (EventSinkLOfTLToLvoid = dart.constFn(dart.fnType(dart.void, [EventSinkOfTL()])))();
    class _HandlerSink extends core.Object {
      ...
      addStream(stream) {
        StreamOfSL().as(stream);
        return this[_inner].addStream(stream.transform(T, new (_StreamHandlerTransformerOfSL$TL()).new({handleData: SLAndEventSinkLOfTLToLvoid().as(this[_transformer$][_handleData$]), handleError: ObjectLAndStackTraceLAndEventSinkLOfTLToLvoid().as(this[_transformer$][_handleError$]), handleDone: C4 || CT.C4})));
      }
      close() {
        let t2, t1;
  ...
  value$.ValueResult$ = dart.generic(T => {
    ...
    class ValueResult extends core.Object {
      ...
      complete(completer) {
        CompleterOfTL().as(completer);
        completer.complete(this.value);
      }
      addTo(sink) {
        EventSinkOfTL().as(sink);
        sink.add(this.value);
      }
      get asFuture() {
  ...
  release_transformer.ReleaseStreamTransformer$ = dart.generic(T => {
    var ResultOfTL = () => (ResultOfTL = dart.constFn(result.Result$(T)))();
    var StreamOfResultLOfTL = () => (StreamOfResultLOfTL = dart.constFn(async.Stream$(ResultOfTL())))();
    var StreamOfTL = () => (StreamOfTL = dart.constFn(async.Stream$(T)))();
    class ReleaseStreamTransformer extends async.StreamTransformerBase$(result.Result$(T), T) {
      bind(source) {
        StreamOfResultLOfTL().as(source);
  ...
  capture_transformer.CaptureStreamTransformer$ = dart.generic(T => {
    ...
    var ResultOfTL = () => (ResultOfTL = dart.constFn(result.Result$(T)))();
    var StreamOfResultLOfTL = () => (StreamOfResultLOfTL = dart.constFn(async.Stream$(ResultOfTL())))();
    var CaptureSinkOfTL = () => (CaptureSinkOfTL = dart.constFn(capture_sink.CaptureSink$(T)))();
    var EventSinkOfResultLOfTL = () => (EventSinkOfResultLOfTL = dart.constFn(async.EventSink$(ResultOfTL())))();
    var EventSinkLOfResultLOfTLToCaptureSinkLOfTL = () => (EventSinkLOfResultLOfTLToCaptureSinkLOfTL = dart.constFn(dart.fnType(CaptureSinkOfTL(), [EventSinkOfResultLOfTL()])))();
    class CaptureStreamTransformer extends async.StreamTransformerBase$(T, result.Result$(T)) {
      bind(source) {
        StreamOfTL().as(source);
  ...
  capture_sink.CaptureSink$ = dart.generic(T => {
    var ValueResultOfTL = () => (ValueResultOfTL = dart.constFn(value$.ValueResult$(T)))();
    var ResultOfTL = () => (ResultOfTL = dart.constFn(result.Result$(T)))();
  ...
  stream_completer.StreamCompleter$ = dart.generic(T => {
    var _CompleterStreamOfTL = () => (_CompleterStreamOfTL = dart.constFn(stream_completer._CompleterStream$(T)))();
    var StreamOfTL = () => (StreamOfTL = dart.constFn(async.Stream$(T)))();
    var FutureOfTL = () => (FutureOfTL = dart.constFn(async.Future$(T)))();
  ...
  subscription_stream.SubscriptionStream$ = dart.generic(T => {
    var _CancelOnErrorSubscriptionWrapperOfTL = () => (_CancelOnErrorSubscriptionWrapperOfTL = dart.constFn(subscription_stream._CancelOnErrorSubscriptionWrapper$(T)))();
  ...
  stream_zip.StreamZip$ = dart.generic(T => {
    var StreamSubscriptionOfTL = () => (StreamSubscriptionOfTL = dart.constFn(async.StreamSubscription$(T)))();
    var JSArrayOfStreamSubscriptionLOfTL = () => (JSArrayOfStreamSubscriptionLOfTL = dart.constFn(_interceptors.JSArray$(StreamSubscriptionOfTL())))();
    var ListOfTL = () => (ListOfTL = dart.constFn(core.List$(T)))();
    var intLAndTLTovoid = () => (intLAndTLTovoid = dart.constFn(dart.fnType(dart.void, [core.int, T])))();
    var TLToNullN = () => (TLToNullN = dart.constFn(dart.fnType(core.Null, [T])))();
    var StreamControllerOfListLOfTL = () => (StreamControllerOfListLOfTL = dart.constFn(async.StreamController$(ListOfTL())))();
  ...
  stream_splitter.StreamSplitter$ = dart.generic(T => {
    var ResultOfTL = () => (ResultOfTL = dart.constFn(result.Result$(T)))();
    var JSArrayOfResultLOfTL = () => (JSArrayOfResultLOfTL = dart.constFn(_interceptors.JSArray$(ResultOfTL())))();
    var StreamControllerOfTL = () => (StreamControllerOfTL = dart.constFn(async.StreamController$(T)))();
    var LinkedHashSetOfStreamControllerLOfTL = () => (LinkedHashSetOfStreamControllerLOfTL = dart.constFn(collection.LinkedHashSet$(StreamControllerOfTL())))();
    var StreamControllerLOfTLToboolL = () => (StreamControllerLOfTLToboolL = dart.constFn(dart.fnType(core.bool, [StreamControllerOfTL()])))();
    var ValueResultOfTL = () => (ValueResultOfTL = dart.constFn(value$.ValueResult$(T)))();
  ...
  future_group.FutureGroup$ = dart.generic(T => {
    var ListOfTL = () => (ListOfTL = dart.constFn(core.List$(T)))();
    var CompleterOfListLOfTL = () => (CompleterOfListLOfTL = dart.constFn(async.Completer$(ListOfTL())))();
  ...
  stream_queue.StreamQueue$ = dart.generic(T => {
    var ResultOfTL = () => (ResultOfTL = dart.constFn(result.Result$(T)))();
    var QueueListOfResultLOfTL = () => (QueueListOfResultLOfTL = dart.constFn(queue_list.QueueList$(ResultOfTL())))();
    var _HasNextRequestOfTL = () => (_HasNextRequestOfTL = dart.constFn(stream_queue._HasNextRequest$(T)))();
    var _LookAheadRequestOfTL = () => (_LookAheadRequestOfTL = dart.constFn(stream_queue._LookAheadRequest$(T)))();
    var _NextRequestOfTL = () => (_NextRequestOfTL = dart.constFn(stream_queue._NextRequest$(T)))();
    var _PeekRequestOfTL = () => (_PeekRequestOfTL = dart.constFn(stream_queue._PeekRequest$(T)))();
    var _RestRequestOfTL = () => (_RestRequestOfTL = dart.constFn(stream_queue._RestRequest$(T)))();
    var _SkipRequestOfTL = () => (_SkipRequestOfTL = dart.constFn(stream_queue._SkipRequest$(T)))();
    var _TakeRequestOfTL = () => (_TakeRequestOfTL = dart.constFn(stream_queue._TakeRequest$(T)))();
    var _TransactionRequestOfTL = () => (_TransactionRequestOfTL = dart.constFn(stream_queue._TransactionRequest$(T)))();
    var _CancelRequestOfTL = () => (_CancelRequestOfTL = dart.constFn(stream_queue._CancelRequest$(T)))();
    var _EmptyStreamOfTL = () => (_EmptyStreamOfTL = dart.constFn(async._EmptyStream$(T)))();
    var SubscriptionStreamOfTL = () => (SubscriptionStreamOfTL = dart.constFn(subscription_stream.SubscriptionStream$(T)))();
    var ValueResultOfTL = () => (ValueResultOfTL = dart.constFn(value$.ValueResult$(T)))();
    var TLToNullN = () => (TLToNullN = dart.constFn(dart.fnType(core.Null, [T])))();
    class StreamQueue extends core.Object {
      ...
      [_extractStream]() {
        if (!dart.test(this[_isClosed$])) dart.assertFailed(null, L30, 445, 12, "_isClosed");
        if (dart.test(this[_isDone$])) {
  ...
  stream_queue.StreamQueueTransaction$ = dart.generic(T => {
    var StreamSplitterOfTL = () => (StreamSplitterOfTL = dart.constFn(stream_splitter.StreamSplitter$(T)))();
    var StreamQueueOfTL = () => (StreamQueueOfTL = dart.constFn(stream_queue.StreamQueue$(T)))();
  ...
  stream_queue._NextRequest$ = dart.generic(T => {
    ...
    class _NextRequest extends core.Object {
      ...
      update(events, isDone) {
        QueueListOfResultLOfTL().as(events);
  ...
  stream_queue._RestRequest$ = dart.generic(T => {
    var StreamCompleterOfTL = () => (StreamCompleterOfTL = dart.constFn(stream_completer.StreamCompleter$(T)))();
    var ResultOfTL = () => (ResultOfTL = dart.constFn(result.Result$(T)))();
    var QueueListOfResultLOfTL = () => (QueueListOfResultLOfTL = dart.constFn(queue_list.QueueList$(ResultOfTL())))();
    var StreamControllerOfTL = () => (StreamControllerOfTL = dart.constFn(async.StreamController$(T)))();
  ...
  stream_queue._TransactionRequest$ = dart.generic(T => {
    var StreamControllerOfTL = () => (StreamControllerOfTL = dart.constFn(async.StreamController$(T)))();
    var StreamQueueTransactionOfTL = () => (StreamQueueTransactionOfTL = dart.constFn(stream_queue.StreamQueueTransaction$(T)))();
    var ResultOfTL = () => (ResultOfTL = dart.constFn(result.Result$(T)))();
    var QueueListOfResultLOfTL = () => (QueueListOfResultLOfTL = dart.constFn(queue_list.QueueList$(ResultOfTL())))();
  ...
  cancelable_operation.CancelableOperation$ = dart.generic(T => {
    ...
    var TLToNullN = () => (TLToNullN = dart.constFn(dart.fnType(core.Null, [T])))();
    var CompleterOfTL = () => (CompleterOfTL = dart.constFn(async.Completer$(T)))();
    var TLTovoid = () => (TLTovoid = dart.constFn(dart.fnType(dart.void, [T])))();
  ...
  cancelable_operation.CancelableCompleter$ = dart.generic(T => {
    var CompleterOfTL = () => (CompleterOfTL = dart.constFn(async.Completer$(T)))();
    var CancelableOperationOfTL = () => (CancelableOperationOfTL = dart.constFn(cancelable_operation.CancelableOperation$(T)))();
    var FutureOrOfTL = () => (FutureOrOfTL = dart.constFn(async.FutureOr$(T)))();
    var FutureOfTL = () => (FutureOfTL = dart.constFn(async.Future$(T)))();
    var TLToNullN = () => (TLToNullN = dart.constFn(dart.fnType(core.Null, [T])))();
    class CancelableCompleter extends core.Object {
      ...
      complete(value = null) {
        ...
        let future = FutureOfTL().as(value);
    ...
    dart.setFieldSignature(CancelableCompleter, () => ({
      ...
      [_onCancel$]: dart.finalFieldType(dart.fnType(dart.dynamic, [])),
  ...
  stream_group.StreamGroup$ = dart.generic(T => {
    var StreamOfTL = () => (StreamOfTL = dart.constFn(async.Stream$(T)))();
    var StreamSubscriptionOfTL = () => (StreamSubscriptionOfTL = dart.constFn(async.StreamSubscription$(T)))();
    var LinkedMapOfStreamLOfTL$StreamSubscriptionLOfTL = () => (LinkedMapOfStreamLOfTL$StreamSubscriptionLOfTL = dart.constFn(_js_helper.LinkedMap$(StreamOfTL(), StreamSubscriptionOfTL())))();
    var StreamControllerOfTL = () => (StreamControllerOfTL = dart.constFn(async.StreamController$(T)))();
    var VoidToStreamSubscriptionLOfTL = () => (VoidToStreamSubscriptionLOfTL = dart.constFn(dart.fnType(StreamSubscriptionOfTL(), [])))();
    var StreamLOfTLAndStreamSubscriptionLOfTLToNullN = () => (StreamLOfTLAndStreamSubscriptionLOfTLToNullN = dart.constFn(dart.fnType(core.Null, [StreamOfTL(), StreamSubscriptionOfTL()])))();
    var StreamSubscriptionLOfTLToFutureLOfvoid = () => (StreamSubscriptionLOfTLToFutureLOfvoid = dart.constFn(dart.fnType(FutureOfvoid(), [StreamSubscriptionOfTL()])))();
    class StreamGroup extends core.Object {
      ...
      [_onCancel$0]() {
        ...
        let futures = this[_subscriptions][$values][$map](FutureOfvoid(), dart.fn(subscription => subscription.cancel(), StreamSubscriptionLOfTLToFutureLOfvoid()))[$where](dart.fn(future => future != null, FutureLOfvoidToboolL()))[$toList]();
  ...
  single_subscription_transformer.SingleSubscriptionTransformer$ = dart.generic((S, T) => {
    var StreamOfSL = () => (StreamOfSL = dart.constFn(async.Stream$(S)))();
    var SLToNullN = () => (SLToNullN = dart.constFn(dart.fnType(core.Null, [S])))();
    var StreamControllerOfTL = () => (StreamControllerOfTL = dart.constFn(async.StreamController$(T)))();
  ...
  lazy_stream.LazyStream$ = dart.generic(T => {
    var StreamOfTL = () => (StreamOfTL = dart.constFn(async.Stream$(T)))();
    var FutureOfStreamLOfTL = () => (FutureOfStreamLOfTL = dart.constFn(async.Future$(StreamOfTL())))();
    class LazyStream extends async.Stream$(T) {
      listen(onData, opts) {
        ...
        let result = callback();
        let stream = null;
        if (FutureOfStreamLOfTL().is(result)) {
          stream = stream_completer.StreamCompleter.fromFuture(T, result);
        } else {
          stream = StreamOfTL().as(result);
        }
  ...
  byte_collector.collectBytes = function collectBytes(source) {
    return byte_collector._collectBytes(FutureOfUint8ListL(), source, dart.fn((_, result) => result, StreamSubscriptionLOfListLOfintLAndFutureLOfUint8ListLToFutureLOfUint8ListL()));
  };
  byte_collector.collectBytesCancelable = function collectBytesCancelable(source) {
    return byte_collector._collectBytes(CancelableOperationOfUint8ListL(), source, dart.fn((subscription, result) => CancelableOperationOfUint8ListL().fromFuture(result, {onCancel: dart.bind(subscription, 'cancel')}), StreamSubscriptionLOfListLOfintLAndFutureLOfUint8ListLToCancelableOperationLOfUint8ListL()));
  };
  ...
  async_cache.AsyncCache$ = dart.generic(T => {
    var FutureOfTL = () => (FutureOfTL = dart.constFn(async.Future$(T)))();
    var VoidToLFutureLOfTL = () => (VoidToLFutureLOfTL = dart.constFn(dart.fnType(FutureOfTL(), [])))();
    var StreamOfTL = () => (StreamOfTL = dart.constFn(async.Stream$(T)))();
    var VoidToLStreamLOfTL = () => (VoidToLStreamLOfTL = dart.constFn(dart.fnType(StreamOfTL(), [])))();
    var StreamSplitterOfTL = () => (StreamSplitterOfTL = dart.constFn(stream_splitter.StreamSplitter$(T)))();
    var _StreamHandlerTransformerOfTL$TL = () => (_StreamHandlerTransformerOfTL$TL = dart.constFn(async._StreamHandlerTransformer$(T, T)))();
    var EventSinkOfTL = () => (EventSinkOfTL = dart.constFn(async.EventSink$(T)))();
    var EventSinkLOfTLToNullN = () => (EventSinkLOfTLToNullN = dart.constFn(dart.fnType(core.Null, [EventSinkOfTL()])))();
    class AsyncCache extends core.Object {
      ...
      fetchStream(callback) {
        ...
        this[_cachedStreamSplitter] == null ? this[_cachedStreamSplitter] = new (StreamSplitterOfTL()).new(callback().transform(T, new (_StreamHandlerTransformerOfTL$TL()).new({handleDone: dart.fn(sink => {
            this[_startStaleTimer]();
            sink.close();
