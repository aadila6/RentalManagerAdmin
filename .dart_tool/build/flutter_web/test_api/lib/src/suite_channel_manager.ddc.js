define(['dart_sdk', 'packages/stream_channel/stream_channel'], function(dart_sdk, packages__stream_channel__stream_channel) {
  ...
  var IdentityMapOfStringL$StreamChannelL = () => (IdentityMapOfStringL$StreamChannelL = dart.constFn(_js_helper.IdentityMap$(core.String, stream_channel.StreamChannel)))();
  var IdentityMapOfStringL$StreamChannelCompleterL = () => (IdentityMapOfStringL$StreamChannelCompleterL = dart.constFn(_js_helper.IdentityMap$(core.String, stream_channel_completer.StreamChannelCompleter)))();
  var LinkedHashSetOfStringL = () => (LinkedHashSetOfStringL = dart.constFn(collection.LinkedHashSet$(core.String)))();
  const CT = Object.create(null);
  var L0 = "package:test_api/src/suite_channel_manager.dart";
  ...
  (suite_channel_manager.SuiteChannelManager.new = function() {
    this[_incomingConnections] = new (IdentityMapOfStringL$StreamChannelL()).new();
    this[_outgoingConnections] = new (IdentityMapOfStringL$StreamChannelCompleterL()).new();
    this[_names] = LinkedHashSetOfStringL().new();
    ;
  ...
  dart.setLibraryUri(suite_channel_manager.SuiteChannelManager, L0);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["suite_channel_manager.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;AA2BM,YAA0B,8CAArB,AAAO,wBAAC;IAAmC;iBAMxB;AACxB,+BAAS,IAAI,eAAc,+BAAC,mCAAa;IAAM;eAGnB;AAC9B,oBAAI,AAAqB,yCAAY,IAAI;AACvC,cAAO,AAAoB,mCAAC,IAAI;YAC3B,eAAI,AAAO,sBAAS,IAAI;AACmC,QAAhE,WAAM,wBAAW,AAA8C,oDAAP,IAAI;;AAE5C,QAAhB,AAAO,iBAAI,IAAI;AACX,wBAAY;AACsB,QAAtC,AAAoB,kCAAC,IAAI,EAAI,SAAS;AACtC,cAAO,AAAU,UAAD;;IAEpB;cAGsB,MAAoB;AACxC,oBAAI,AAAqB,yCAAY,IAAI;AACc,QAArD,AAAqB,AAAa,oCAAN,IAAI,aAAa,OAAO;YAC/C,eAAI,AAAqB,yCAAY,IAAI;AACyB,QAAvE,WAAM,wBAAW,AAAqD,2DAAP,IAAI;;AAE/B,QAApC,AAAoB,kCAAC,IAAI,EAAI,OAAO;;IAExC;;;IA5CM,6BAA8C;IAI9C,6BAAuD;IAGvD,eAAiB;;EAsCzB;;;;;;;;;;;;;;;;;MAnDM,iCAAW;YAAG","file":"suite_channel_manager.ddc.js"}');
  // Exports:
  return {
